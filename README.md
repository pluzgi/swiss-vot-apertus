...
✅ **Conversational Interface** - Natural language queries via OpenWebUI
✅ **RAG-Powered Answers** - Semantic search through brochure texts using ChromaDB
✅ **Multilingual Support** - German, French, and Italian
✅ **Comprehensive Data** - Metadata, party positions, parliamentary votes
✅ **Official Sources** - Pre-extracted brochure texts with PDF links
✅ **Swiss AI** - Powered by Swisscom Apertus 70B model
...
├── STEP1-COMPLETE.md           # Migration progress
│
├── backend/                    # FastAPI Application
│   ├── main.py                 # API endpoints & OpenWebUI Pipeline
│   ├── config.py               # Configuration management
│   ├── requirements.txt        # Python dependencies
│   └── Dockerfile              # Container definition
│
├── data/                       # Voting Data
│   └── current_votes.json      # Swiss initiatives (auto-updated)
│
├── scripts/                    # Data Pipeline
│   ├── extract_voting_data.py  # Web scraper
│   └── validate_voting_data.py # Data validation
│
└── .github/workflows/          # Automation
    └── update_initiatives.yml  # Weekly data updates
```
...
### 🔄 Step 2: Data & RAG Pipeline (IN PROGRESS)
...
### 🔜 Step 3: LLM Integration (PENDING)
...
| `/api/initiatives` | GET | 🔜 | List all initiatives |
| `/api/initiatives/{id}` | GET | 🔜 | Get by ID |
| `/api/search` | POST | 🔜 | Keyword search |
| `/api/rag/query` | POST | 🔜 | RAG-enabled search |
...
|----------|-------------|----------|
| `APERTUS_API_KEY` | Swisscom API key | ✅ Yes |
...
**Made with ❤️ for informed voting decisions**
